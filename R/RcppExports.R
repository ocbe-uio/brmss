...
#'
run_mcmc <- function(y, X, L, family, nIter, burnin, thin, tick, gamma_sampler, threads, n, nsamp, ninit, convex, npoint, initList, rangeList, hyperparList) {
    .Call(`_brmss_run_mcmc`, y, X, L, family, nIter, burnin, thin, tick, gamma_sampler, threads, n, nsamp, ninit, convex, npoint, initList, rangeList, hyperparList)
}
